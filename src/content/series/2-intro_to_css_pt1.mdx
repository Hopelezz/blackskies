...
ogImage: ""
description: This is the 2nd post in the series of guides to Web Dev. In this post, we will learn about the basics of CSS and how to use it to style our web pages.
---
...
> You can find the next article in the series here: [Intro to CSS Part 2](/posts/3-intro_to_css_pt2).
